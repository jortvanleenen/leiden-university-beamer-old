...
% OPTION: The theme's footer has an automatic translation for 'dutch', all other languages will display their footer in English by default. Manual changes can be made in 'beamerouterthemelu.sty'.
\documentclass[english, aspectratio=169]{beamer}

% The theme works best with the Minion Pro font installed. It is, however, not allowed to redistribute this font and it has, therefore, not been included.
%
% OPTIONS FOR THEME:
...
% OPTION: optional for references
...
% OPTION: \titlegraphic can be provided to add the logo of an institution or organisation to the title page
% \titlegraphic{%
